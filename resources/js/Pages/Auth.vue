<template>
    <div class="w-screen min-h-[100vh] flex flex-col justify-center items-center bg-blue-900">
        <div class="w-4/12 min-h-[40vh] bg-gray-100 flex flex-col justify-center items-center rounded-lg shadow-lg py-10">
            <h1 class="text-2xl text-black font-semibold uppercase py-4">Login</h1>
            ...
            <form @submit.prevent="submitForm()" method="POST" class="w-full h-full px-4 grid grid-cols-12 gap-6 place-items-center place-content-center">
                <div class="col-span-12 w-8/12">
                    <label for="email" class="text-black text-2xl font-semibold">E-mail</label><br>
                ...
                <div class="col-span-12 w-8/12">
                    <label for="password" class="text-black text-2xl font-semibold">Senha</label><br>
                ...
                <div class="col-span-12 w-8/12 flex justify-center items-center">
                    <button type="submit" name="submitButton" id="submitButton" class="w-6/12 h-14 bg-blue-900 text-white text-xl font-semibold rounded-md hover:scale-105 duration-200">Entrar</button>
                </div>
            </form>
        </div>
    </div>
